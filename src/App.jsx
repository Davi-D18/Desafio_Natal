     ...
     <main>
      ...
      <section className={S.curiosidade}>
        <div className={S.containerCuriosidade}>
          <img src={arvoreBola} alt="Imagem de uma arvore dentro de uma bola" />   

          <p id="curiosidade-scrool">A origem do globo de neve é incerta, mas acredita-se que tenha surgido na Europa no século XIX, tornando-se um símbolo de magia, afeto e encantamento, especialmente no Natal, trazendo um toque de nostalgia e maravilha para as celebrações e encantando gerações ao redor do mundo.</p>
        </div>
      </section>
